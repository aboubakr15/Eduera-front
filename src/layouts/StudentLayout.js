...
const mainNavItems = [
  ...
  { label: "Enrollments", icon: <MdAssignment size={18} />, path: "/student/enrollments" },
  { label: "Assignments", icon: <FaClipboardList size={18} />, path: "/student/assignments" },
  ...
  { label: "Notifications", icon: <MdNotifications size={20} />, path: "/student/notifications" },
];
    ...
    <div className="flex h-screen overflow-hidden">
      <div className={`relative h-screen bg-white border-r border-gray-100 flex flex-col shadow-sm transition-all duration-300 ease-in-out ${isOpen ? "w-60" : "w-16"}`}>
        ...
        <nav className="px-2 pb-6 space-y-0.5">
          ...
          <button onClick={handleLogout} className={`w-full flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium transition-all duration-150 text-gray-500 hover:bg-red-50 hover:text-red-500 ${!isOpen ? "justify-center" : ""}`}>
